...
<html lang="ko">
  <head>
    ...
    <link rel="canonical" href="https://smitu.kr/notice.php" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="ko_KR" />
    <meta property="og:site_name" content="과수정 교원노동조합" />
    <meta property="og:title" content="공지사항 | 과수정 교원노동조합" />
    <meta
  ...
  <body>
    ...
    <aside class="site-sidebar" aria-label="사이트 사이드바">
      ...
      <nav class="site-nav" id="site-nav" aria-label="주요 메뉴">
        <ul class="site-nav__list">
          ...
          <li><a class="site-nav__link is-active" href="notice.php" data-section="notice">공지사항</a></li>
    ...
    <main class="site-main" id="main">
      <section class="section section--page" id="notice" aria-labelledby="notice-title">
        <div class="page-panel glass-panel">
          <header class="page-header">
            <span class="section-panel__bar" aria-hidden="true"></span>
            <h1 class="page-title" id="notice-title">공지사항</h1>
            <p class="page-copy">조합의 주요 일정, 회의 안내, 교섭 소식 등을 전합니다.</p>
          </header>

          <div class="page-list board-list" id="notice-page-list"></div>
        </div>
      </section>
    </main>
