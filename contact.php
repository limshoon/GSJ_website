...
<html lang="ko">
  <head>
    ...
    <meta
      name="description"
      content="과수정 교원노동조합의 전화번호, 이메일, 주소, 운영시간 등 문의 정보를 확인할 수 있는 페이지"
    />
    <meta name="robots" content="index, follow" />
    <meta name="theme-color" content="#1346FF" />
    <link rel="canonical" href="https://smitu.kr/contact.php" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="ko_KR" />
    <meta property="og:site_name" content="과수정 교원노동조합" />
    <meta property="og:title" content="문의 | 과수정 교원노동조합" />
    <meta
      property="og:description"
      content="과수정 교원노동조합의 전화번호, 이메일, 주소, 운영시간 등 문의 정보를 확인할 수 있는 페이지"
    />
    <meta property="og:url" content="https://smitu.kr/contact.php" />
    ...
    <script src="assets/js/main.js?v=20260717-mobileui" defer></script>
    <script src="assets/js/contact-map.js?v=20260716-cafe24" defer></script>
  </head>
  <body>
    ...
    <aside class="site-sidebar" aria-label="사이트 사이드바">
      ...
      <nav class="site-nav" id="site-nav" aria-label="주요 메뉴">
        <ul class="site-nav__list">
          ...
          <li><a class="site-nav__link is-active" href="contact.php" data-section="contact">문의</a></li>
        </ul>
    ...
    <main class="site-main" id="main">
      <section class="section section--page" id="contact" aria-labelledby="contact-title">
        <div class="page-panel glass-panel">
          <header class="page-header">
            <span class="section-panel__bar" aria-hidden="true"></span>
            <h1 class="page-title" id="contact-title">문의</h1>
            <p class="page-copy">전화번호, 이메일, 주소, 운영시간 등 조합 문의 정보를 안내합니다.</p>
          </header>

          <div class="contact-page-list" id="contact-page-list"></div>
        </div>
      </section>
    </main>
