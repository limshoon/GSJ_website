...
<html lang="ko">
  <head>
    ...
    <meta
      name="description"
      content="과수정 교원노동조합의 정책 자료, 연구 자료, 교육 자료, 조합 자료를 확인할 수 있는 페이지"
    />
    <meta name="robots" content="index, follow" />
    <meta name="theme-color" content="#1346FF" />
    <link rel="canonical" href="https://smitu.kr/resource.php" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="ko_KR" />
    <meta property="og:site_name" content="과수정 교원노동조합" />
    <meta property="og:title" content="자료실 | 과수정 교원노동조합" />
    <meta
      property="og:description"
      content="과수정 교원노동조합의 정책 자료, 연구 자료, 교육 자료, 조합 자료를 확인할 수 있는 페이지"
    />
    <meta property="og:url" content="https://smitu.kr/resource.php" />
  ...
  <body>
    ...
    <aside class="site-sidebar" aria-label="사이트 사이드바">
      ...
      <nav class="site-nav" id="site-nav" aria-label="주요 메뉴">
        <ul class="site-nav__list">
          ...
          <li><a class="site-nav__link is-active" href="resource.php" data-section="resources">자료실</a></li>
    ...
    <main class="site-main" id="main">
      <section class="section section--page" id="resources" aria-labelledby="resources-title">
        <div class="page-panel glass-panel">
          <header class="page-header">
            <span class="section-panel__bar" aria-hidden="true"></span>
            <h1 class="page-title" id="resources-title">자료실</h1>
            <p class="page-copy">교육 정책, 연구, 수업, 조합 운영과 관련된 자료를 모아둡니다.</p>
          </header>

          <div class="page-list board-list resources-page-grid" id="resources-page-list"></div>
        </div>
      </section>
    </main>
