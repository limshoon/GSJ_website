...
<html lang="ko">
  <head>
    ...
    <meta name="description" content="과수정 교원노동조합의 소개와 운영 원칙을 확인할 수 있는 페이지" />
    <meta name="robots" content="index, follow" />
    <meta name="theme-color" content="#1346FF" />
    <link rel="canonical" href="https://smitu.kr/about.php" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="ko_KR" />
    <meta property="og:site_name" content="과수정 교원노동조합" />
    <meta property="og:title" content="조합소개 | 과수정 교원노동조합" />
    <meta property="og:description" content="과수정 교원노동조합의 소개와 운영 원칙을 확인할 수 있는 페이지" />
    <meta property="og:url" content="https://smitu.kr/about.php" />
  ...
  <body>
    ...
    <aside class="site-sidebar" aria-label="사이트 사이드바">
      ...
      <nav class="site-nav" id="site-nav" aria-label="주요 메뉴">
        <ul class="site-nav__list">
          ...
          <li><a class="site-nav__link is-active" href="about.php" data-section="about">조합소개</a></li>
    ...
    <main class="site-main" id="main">
      <section class="section section--page" id="about" aria-labelledby="about-title">
        <div class="page-panel glass-panel">
          <header class="page-header">
            <span class="section-panel__bar" aria-hidden="true"></span>
            <h1 class="page-title" id="about-title">조합소개</h1>
            <p class="page-copy">과수정 교원노동조합의 목표와 원칙을 소개합니다.</p>
          </header>

          <div class="info-list" id="about-list"></div>
        </div>
      </section>
    </main>
