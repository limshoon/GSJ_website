...
<html lang="ko">
  <head>
    ...
    <meta
      name="description"
      content="과수정 교원노동조합의 주요 포스터와 안내 이미지를 모아둔 페이지"
    />
    <meta name="robots" content="index, follow" />
    <meta name="theme-color" content="#1346FF" />
    <link rel="canonical" href="https://smitu.kr/poster.php" />
    <meta property="og:type" content="website" />
    <meta property="og:locale" content="ko_KR" />
    <meta property="og:site_name" content="과수정 교원노동조합" />
    <meta property="og:title" content="포스터 | 과수정 교원노동조합" />
    <meta
      property="og:description"
      content="과수정 교원노동조합의 주요 포스터와 안내 이미지를 모아둔 페이지"
    />
    <meta property="og:url" content="https://smitu.kr/poster.php" />
  ...
  <body>
    ...
    <aside class="site-sidebar" aria-label="사이트 사이드바">
      ...
      <nav class="site-nav" id="site-nav" aria-label="주요 메뉴">
        <ul class="site-nav__list">
          ...
          <li><a class="site-nav__link is-active" href="poster.php" data-section="posters">포스터</a></li>
    ...
    <main class="site-main" id="main">
      <section class="section section--page" id="posters" aria-labelledby="poster-page-title">
        <div class="page-panel glass-panel poster-page-panel">
          <header class="page-header">
            <span class="section-panel__bar" aria-hidden="true"></span>
            <h1 class="page-title" id="poster-page-title">포스터</h1>
            <p class="page-copy">조합의 주요 안내와 캠페인 포스터를 한 곳에 모아둡니다.</p>
          </header>

          <div class="poster-archive-grid" id="poster-page-list"></div>
        </div>
      </section>
    </main>
