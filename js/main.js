...
const aboutItems = [
  ...
  {
    title: "연혁",
    description: "과수정 노동조합의 걸어온 길과 주요 활동을 소개합니다.",
    icon: "flag",
  },
];
...
function renderNotices() {
  ...
  noticeList.innerHTML = notices
    .map(
      (notice) => `
        <a class="notice-list__item" href="#" role="listitem" aria-label="${escapeHtml(notice.title)}">
...
function initScrollSpy() {
  ...
  const getOffset = () => {
    ...
    return window.innerWidth <= 760 ? sidebar.offsetHeight + 28 : 96;
  };
